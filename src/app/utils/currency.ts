...
// تنسيق العملات
export function formatCurrency(amount: number, currency: CurrencyCode = 'YER', locale: string = 'ar-YE'): string {
...
// تنسيق الأعداد
export function formatNumber(value: number, locale: string = 'ar-YE', decimals: number = 0): string {
...
// تنسيق التواريخ
export function formatDate(date: Date | string, locale: string = 'ar-YE', format: 'short' | 'medium' | 'long' = 'medium'): string {
...
// تنسيق الوقت
export function formatTime(date: Date | string, locale: string = 'ar-YE'): string {
    const dateObj = typeof date === 'string' ? new Date(date) : date;
...
export function exportFormattedExcel(): void {
