...
export function CommandPalette({ isOpen, onClose, commands }: CommandPaletteProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[600px] flex flex-col animate-scaleIn"
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="relative">
            ...
            <input
              ...
              placeholder="ابحث عن أمر... (Ctrl+K)"
              className="w-full pr-10 pl-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-1 text-xs text-gray-500">
                      ...
                      {cmd.shortcut && (
                        <div className="flex items-center gap-1">
                          {cmd.shortcut.split('+').map((key) => (
                            <kbd
                              key={key}
                              className="px-1.5 py-0.5 bg-gray-200 border border-gray-300 rounded text-xs font-semibold text-gray-700"
                            >
                              {key}
                            </kbd>
                          ))}
...
export function useCommandPalette() {
  ...
  const defaultCommands: CommandItem[] = [
    ...
    },
    {
      ...
      icon: <Hash size={16} className="text-purple-600" />,
