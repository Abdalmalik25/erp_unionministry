...
const ABOUT_SECTIONS: { title: string; body: string }[] = [
  {
    title: "السياق الاستراتيجي: لماذا هذه المنظومة الآن؟",
...
المبدأ الحاكم بسيط وصارم في آن: بيانة تُدخل مرة في سجلها الوطني فتعبّر كل الجهات بصلاحيات مضبوطة. لا نسخ متضاربة، ولا مسارات موازية، ولا قرار يخرج عن الدورة الموثقة.`,
  },
  {
    ...
    <PublicLayout>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-xs text-muted-foreground mb-4 max-w-3xl leading-relaxed">
          المنظومة ليست أداة داخلية فحسب؛ إنها عقد مؤسسي مع كل طرفٍ في سوق العمل. هذه هي التزاماتنا المعلنة تجاهكم:
        </p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-8">
        <div className="rounded-xl border-r-4 border-primary/50 bg-primary/[.04] p-4">
          <p className="text-[13px] text-muted-foreground leading-relaxed">
            لكل خدمةٍ هنا وعدٌ ثلاثي: زمن معلن، ومسار موثق يمكنك تتبعه خطوة بخطوة برقم مرجعي،
            وقرار معلل يعرف مصدره ومعتمده. افتح أي خدمة لتعرف ما تحقق لك بالضبط.
          </p>
        </div>
